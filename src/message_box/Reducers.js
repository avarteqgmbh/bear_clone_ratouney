    ...
    switch (action.type) {
        case SYNC_NOTE_SUCCESS:
            args = {
                ...
                icon: <Icon type={MessageBoxData.SYNC_NOTE_SUCCESS.icon} style={MessageBoxData.SYNC_NOTE_SUCCESS.style} />
            };
        ...
        case SYNC_NOTE_FAILURE:
            args = {
                ...
                icon: <Icon type={MessageBoxData.SYNC_NOTE_FAILURE.icon} style={MessageBoxData.SYNC_NOTE_FAILURE.style} />
            };
            notification.open(args);
            break;
