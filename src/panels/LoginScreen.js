    ...
    handleSubmit(e) {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                this.props.onFormSubmit(values.username, values.password)
            }
        });
    }
    render() {
        ...
        return (
            <Form onSubmit={(e) => this.handleSubmit(e)} className="login-form">
                    ...
                    <Col offset={8} span={6} >
                        <FormItem>
                            {getFieldDecorator('password', {
                                ...
                                <Input prefix={<Icon type="lock" style={{ fontSize: 13 }} />} type="password" placeholder="Not John Doe" />
                            )}
                        </FormItem>
                    </Col>
                </Row>
                <FormItem>
                    ...
                    <Row>
                        <Col offset={8} >
                            <Button loading={this.props.loggin} type="primary" htmlType="submit" className="login-form-button" style={{ width: '360px', height: '35px' }} >
                                Log in
                            </Button>
                        </Col>
                    </Row>
